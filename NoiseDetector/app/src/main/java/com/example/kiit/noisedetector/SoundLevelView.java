package com.example.kiit.noisedetector;
...
public class SoundLevelView extends View {
    ...
    public SoundLevelView(Context context, AttributeSet attrs) {
        ...
        mGreen  = context.getResources().getDrawable(R.drawable.ic_android__green);
        mRed    = context.getResources().getDrawable(R.drawable.ic_android_red);
